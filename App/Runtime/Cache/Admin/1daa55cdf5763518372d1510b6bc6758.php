...
<nav class="breadcrumb">
    ...
    基本设置 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" >
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<label>
                            ...
                            <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>登录超时开关：</label>
					<div class="formControls col-xs-8 col-sm-9">
					<label>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-copyright" placeholder="&copy; 2016 uicic.com" value="<?php echo ($config["copyright"]); ?>" class="input-text copyright">
                                ...
                                <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>底部地址：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-info1" placeholder="" value="<?php echo ($config["info1"]); ?>" class="input-text info1">
					</div>
				</div>
