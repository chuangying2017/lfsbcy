...
<div class="pd-20">
  <div class="Huiform">
 <form action="/index.php/Admin/Picture/printedit/id/49.html"   method="post" enctype="multipart/form-data" class="SubmiForm" id="form-article-add"  >
      <table class="table table-bg">
        <tbody>
                ...
                <td>
                    <span><input type="file" class="input-text" style="width:300px;" name="url_img" ></span>(大小200*150)
                </td>
          ...
          <tr>
            ...
            <td>
                <input type="text" style="width:300px" class="input-text" name="title"  value="<?php echo ($data["title"]); ?>"  placeholder="" 
          ...
          <tr>
            ...
            <td>
			<textarea id="editor"  style="width:900px;height:400px;" class='editor' name='content'  datatype="*" nullmsg="内容不能为空"  ><?php echo (htmlspecialchars_decode($data["content"])); ?></textarea>
			</td>
          </tr>
          <tr>
            <th>
                <input type='hidden' name='pid' class='pid' value='<?php echo ($id); ?>' >
            </th>
