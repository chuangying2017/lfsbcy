 ...
 日期范围：
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
	...
	<td class="text-l"><?php echo ($vo["content"]); ?></td>
        ...
        <td class="td-status"><a title="删除" href="javascript:;" onClick="del(this,<?php echo ($vo["id"]); ?>,'<?php echo U('Message/messageDel');?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
