...
<div class="frame">
    ...
    <div class="bodydiv w10">
            <div class="shang"></div>
        <div class="productright1 productright1-bg" style="width:90%;box-sizing: border-box;margin-left: 5%;border: none;    padding-bottom: 30px;margin-top:-50px;">
            <div class="callcenter" style="overflow-y: hidden;border: 0;">
