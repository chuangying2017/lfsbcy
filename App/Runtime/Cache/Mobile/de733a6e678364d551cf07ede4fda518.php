...
<div class="frame">
    <div class="head">
        ...
        <div class="name" style="text-align: center;font-size: 15px;">百草传说</div>
...
<script>
    ...
    <div class="productright">
        <div class="productrighttwo">
            <div class="act_body">
                <a>
                    <?php if(is_array($data1)): foreach($data1 as $k=>$v): ?><a href="<?php echo U('Article/pages',array('id'=>$v['art_type'],'ids'=>$v['id']));?>" style="width: 87%;
