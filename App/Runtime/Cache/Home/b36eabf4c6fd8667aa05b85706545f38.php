...
<body>
    ...
    <div class="bodydiv w10">
        <ul class="productleft">
            <li class="first"></li>
            <li><a href="<?php echo U('Article/pages',array('id'=>'1','ids'=>'35'));?>" <?php if($_GET['id']== 1 ): ?>class="producthot"<?php endif; ?> >产品简介</a></li>
            <li><a href="<?php echo U('Article/pages',array('id'=>'4','ids'=>'42'));?>" <?php if($_GET['id']== 4 ): ?>class="producthot"<?php endif; ?> >功效推荐</a></li>
            <li><a href="<?php echo U('Article/pages',array('id'=>'5','ids'=>'33'));?>" <?php if($_GET['id']== 5 ): ?>class="producthot"<?php endif; ?> >产品荣誉</a></li>
            <?php if(is_array($data)): foreach($data as $k=>$v): ?><li><a href="<?php echo U('Article/product',array('id'=>$v['art_type']));?>" ><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; ?>
            <li class="last"></li>
        </ul>
        <div class="productright">
            <div class="productrighttwo" style="overflow-y: hidden;  min-height: 612px;height:auto;">
                  <?php if($_GET['id']== "100" ): ?><div class="callcenter" style="margin:-6% -6%;width: 103%">
                    ...
                    <div class="callcenter" style="margin:-6% -6%;width: 103%">
                        <?php if(is_array($list)): foreach($list as $k=>$v): ?><a href="<?php echo U('Article/pages',array('id'=>$v['art_type'],ids=>$v['id']));?>" >
                        <div style="width: 100%;height: 150px;margin: 5% 0%;border-bottom: 1px solid #d7cfbc">
                            <div style="float: left;width: 20%;height: 100%"><img src="/<?php echo ($v["art_img"]); ?>" alt="" style="width: 90%;height: 90%;"></div>
                            <div style="float: left;width: 70%;height: 100%">
                                <p style="font-size: 25px;margin-bottom: 15px;line-height: 120px"> <span><?php echo ($v["art_title"]); ?></span></p>
