    ...
    <style>
      ...
      <div class="bodydiv w10">
        <div class="productright" style="width: 980px">
                <?php if($_GET['id']== "40" ): ?><div class="callcenter" >
                    <div style="    color: #8d5028;">
                        <ul class="sharingul">
                            <?php if(is_array($map)): foreach($map as $k=>$v): ?><li><a href="<?php echo U('Article/pages_chanp',array('id'=>$v['art_type'],'ids'=>$v['id']));?>" ><?php echo ($v["art_title"]); ?></a></li><?php endforeach; endif; ?>
                        </ul>
                    </div>
                            </div>
                <?php else: ?>
