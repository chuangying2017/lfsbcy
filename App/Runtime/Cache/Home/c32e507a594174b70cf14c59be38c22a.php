...
<head>
    ...
    <script type="text/javascript">
        ...
        document.write(unescape("%3Cspan id='cnzz_stat_icon_1272443997'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s13.cnzz.com/z_stat.php%3Fid%3D1272443997%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));
		$('#cnzz_stat_icon_1272443997').hide();
</script>
    <script type="text/javascript">
...
<style>
        #rollss { padding: 0; width: 1000px; margin: 38px auto 0; position: relative; }
            #rollss .warpss { margin: 0 auto; width: 700px; height: 176px; text-align: center; overflow: hidden; position: relative; }
            ...
            .swiper-left, .swiper-right, .swiper-rights, .swiper-lefts {
                position: absolute;
            }
            .img-borders, .img-border {
                position: relative;
                width: 1000px;
                height: 120px;
                margin: 0 auto;
