        ...
        <div class="productright">
            <div class="callcenter" style="    overflow-y: hidden;">
              ...
              <?php echo ($page); ?>
                    ...
                    <?php else: ?>
                     <form action="/index.php/article/about/id/20.html"  method="post" enctype="multipart/form-data" class="SubmiForm" id="form-article-add"  >
        ...
        $(".SubmiForm").Validform({
            callback:function(form){
                $("#form-article-add").ajaxSubmit({
                    ...
                    dataType:'json',
                    type:'post',
                    url: "/index.php/Article/add_article_data",
                    async:false,
